...
class Script(scripts.Script):
    ...
    def __init__(self,ori_UNet):
        ...
        self.plug_ID = PluggableInteractDiffusion(ori_UNet,interactdiffusion_state_dict) #Original Unet model, state_dict
    ...
    def process(self, p: StableDiffusionProcessing, boxes,grounding_texts,enabled,stage_one,stage_two,strength):#need to refine the way we pass aurguments:
